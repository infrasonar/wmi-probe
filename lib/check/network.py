...
ADAPTER_CONF_QUERY = Query("""
    ...
    IPFilterSecurityEnabled, IPSecPermitIPProtocols, IPSecPermitTCPPorts,
    IPSecPermitUDPPorts, IPSubnet, IPUseZeroBroadcast, InterfaceIndex,
    KeepAliveInterval, KeepAliveTime, MTU, NumForwardPackets,
